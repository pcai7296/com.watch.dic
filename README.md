...
本仓库是 **432×514（矩形屏）** 单分辨率适配分支，包名 `com.watch.dic.w432`。基于小米 `aiot-toolkit` 开发，内置 **20,000+ 条词汇**（数据源：ECDICT + CC-CEDICT + BNC/COCA 词族）。
...
构建产物为 `dist/com.watch.dic.w432.debug.3.1.0.rpk`（已纳入 Git）。
