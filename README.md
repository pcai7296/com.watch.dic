<h1 align="center">腕上词典 — 466×466 圆屏 适配版</h1>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/屏幕-466×466-ff6b35?style=flat-square" alt="Screens" />
...
本仓库是 **466×466（圆屏）** 单分辨率适配分支，包名 `com.watch.dic.w466`。基于小米 `aiot-toolkit` 开发，内置 **20,000+ 条词汇**（数据源：ECDICT + CC-CEDICT + BNC/COCA 词族）。
...
- **📱 466×466 单屏适配** — 本分支针对 466×466 屏幕深度调优，布局、字号、间距全部按此分辨率定制
...
构建产物为 `dist/com.watch.dic.w466.debug.3.1.0.rpk`（已纳入 Git）。
...
| **屏幕** | 466×466 圆屏 单屏适配，`designWidth: device-width` |
