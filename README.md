...
本仓库是 **336×480（矩形屏）** 单分辨率适配分支，包名 `com.watch.dic.w336`。基于小米 `aiot-toolkit` 开发，内置 **15,000+ 条词汇**（数据源：ECDICT + CC-CEDICT + BNC/COCA 词族）。
...
构建产物为 `dist/com.watch.dic.w336.debug.2.3.0.rpk`（已纳入 Git）。
