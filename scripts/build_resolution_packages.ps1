...
$targets = @(
  ...
  @{ Id = "W336"; Width = 336; Height = 480; Script = "build:336" },
  @{ Id = "W432"; Width = 432; Height = 514; Script = "build:432" },
...
foreach ($target in $targets) {
  ...
  $name = "com.watch.dic.w336.debug.3.1.0.$($target.Id.ToLowerInvariant()).rpk"
